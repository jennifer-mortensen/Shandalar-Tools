...
def get_user_banned_cards(filename):
    ...
    user_banned_cards = get_csv_column(filename, 0, skip_prefixes=[const.COMMENT_PREFIX])
...
def get_csv_column(file_name, column_number, csv_delimiter=const.DEFAULT_CSV_DELIMITER, starting_index=0, starting_header="", skip_prefixes=None):
    csv_column = []
