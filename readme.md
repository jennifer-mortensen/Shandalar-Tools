...
```text
NFO: Checking for conflicts between additional bans and additional cards...
...
WARNING: Some additional cards are not supported in the Shandalar data set and cannot be included. Example: blackest lotus
Full details written to the log file (default: C:\Users\jpers\Documents\My Hub\Development\Shandalar-Tools\logs\shandalar_tools.log)
INFO: Checking for redundant custom additions...
INFO: No redundant additions found!
INFO: Checking for redundant bans...
WARNING: 8 duplicate entries detected across the unsupported and additional bans lists. Examples: dralnu, lich lord; furnace of rath; ith, high arcanist; mangara of corondar; oops this card doesn't exist...
Full details written to the log file (default: C:\Users\jpers\Documents\My Hub\Development\Shandalar-Tools\logs\shandalar_tools.log)
